                ...
                <div className="lg:w-3/5 lg:pr-8 text-left">
                    <article className="mx-20">
                        <h1 className="text-5xl font-semibold tracking-wide text-[#333333] leading-tight mb-6">
                            Preservando os Oceanos: <br /> Coleta de Lixo
                            Marítimo com Sustentabilidade
                        </h1>
                        <p className="text-lg text-gray-600 mb-8">
                            Unimos forças para combater a poluição dos oceanos,
                            promovendo a coleta de <br /> lixo marítimo e ações
                            que protegem a vida marinha.
                        </p>
